...
with col2:
    ...
    df = pd.DataFrame([[round(roi[0],2),'3 months',f"{round(roi[0],2)}x"],
            ...
            [round(roi[3],2),'12 months',f"{round(roi[3],2)}x"],
            [round(roi[4],2),'15 months',f"{round(roi[4],2)}x"],
            [round(roi[5],2),'18 months',f"{round(roi[5],2)}x"],], columns=['ROI','Lockup period','ROI x'])
